    ...
    <>
      ...
      >
        ...
        <div className="w-full max-w-[500px] flex flex-col gap-6 z-10 relative">
          ...
          {/* Action Pill */}
          <div className="flex items-center justify-between bg-black/50 backdrop-blur-3xl border border-white/10 rounded-full p-2 pl-8 shadow-2xl relative overflow-visible group">
            ...
            <div className="flex gap-2">
               ...
               <button 
                  ...
                  className="bg-primary hover:bg-[#A32025] text-white font-black h-14 px-10 rounded-full flex items-center gap-3 transition-all shadow-[0_10px_20px_rgba(209,35,43,0.3)] hover:scale-105 active:scale-95 min-w-[140px] justify-center"
               >
                  LO QUIERO <ChevronUp className="w-4 h-4 animate-bounce" />
               </button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-6 opacity-20">
              ...
              <span className="text-[8px] font-bold uppercase tracking-widest text-snow">Ruta 9 Original</span>
          </div>
        </div>
      </motion.div>
